...
time.sleep(0)
print(" ")
print("_________________TRYING TO REACH THE SERVER________________")
time.sleep(2)
print("_________________TRYING TO CRASHED THE SERVER______________")
time.sleep(2)
print("_________________TRYING TO BYPASS THE SERVER_______________")
time.sleep(2)
print("_________________CONNECTING TO SERVER______________________")
time.sleep(2)
